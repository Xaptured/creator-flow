 ...
 *
 * <p>Job data keys: {@code contentId}, {@code ownerId}, {@code platform}, {@code windowHours}.</p>
 */
@Component
public class MetricsFetchJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        log.info("MetricsFetchJob executing — contentId: {}, platform: {}, window: {}h", contentId, platform, windowHours);

        try {
            analyticsService.fetchAndRecord(contentId, ownerId, platform, windowHours);
        } catch (Exception e) {
